/*
 ...
 Alterado por Leonardo Weslei Diniz<leonardoweslei@gmail.com>

*/
(function($) {
    $.fn.jloupe = function(opts) {
    	opts = $.extend({class:'.jLoupe',attr:'src'}, opts || {});
		...
		$(opts.class).each(function(){
				var s = ($(this).attr(opts.attr) != undefined) ? $(this).attr(opts.attr) : $(this).attr('src');
